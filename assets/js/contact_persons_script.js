$(document).ready(function(){
    ...
    $(".add-new").click(function(){
        ...
        var row = '<tr>' +
            '<td><input type="text" class="c_p_salutation" name="salutation" id="salutation></td>' +
            ...
            '<td><input type="text" class="form-control" name="wphone" id="wphone"></td>' +
            '<td><input type="text" class="form-control" name="mobile" id="mobile"></td>' +
            '<td><input type="text" class="form-control" name="skype" id="skype"></td>' +
